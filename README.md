...
* *Inherits all Support Agent privileges.*
...
* `status` (Enum: 'active', 'inactive') - *Used for Admin-level access revoking.*
...
### `return_status_logs`
* *Tracks the lifecycle of a return for auditing purposes.*
* `id` (PK)
